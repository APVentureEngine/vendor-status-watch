# Anchor Host outage history — every incident their status page has posted
...
This page republishes what Anchor Host posted on its own status page. It is rebuilt
daily by an automated poller — no login, no account, MIT-licensed data.

## Recent Anchor Host incidents

| Started | Incident | Impact | Length |
| --- | --- | --- | ---: |
| 2026-08-19 | [WordPress 7.1 + WP Rocket PHP Fatal](https://stspg.io/984zcq2n4gry) | major | 22 min |
| 2026-04-01 | [Kinsta Server Outage](https://stspg.io/fkznq07ljhc6) | none | 46 min |
| 2025-11-18 | [Cloudflare outage](https://stspg.io/95d0jxrwr7y9) | critical | 99 min |

Newest 3 of 3. Full machine-readable history:
[`history/anchor-host.json`](https://raw.githubusercontent.com/APVentureEngine/vendor-status-watch/main/history/anchor-host.json).
...
**2026-09-04** — it is not a claim about Anchor Host's
...
| | |
| --- | --- |
| This vendor's raw history (JSON) | [`history/anchor-host.json`](https://raw.githubusercontent.com/APVentureEngine/vendor-status-watch/main/history/anchor-host.json) |
...
| Alert your Slack/Discord when Anchor Host breaks | [free MIT GitHub Actions template](https://github.com/APVentureEngine/vendor-status-watch-template) |
...
| Browsable board with charts | [Anchor Host on the live site](https://approjects-vendor-status-watch.static.hf.space/v/anchor-host.html) |
