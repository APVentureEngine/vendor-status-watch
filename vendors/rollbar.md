...
**14 Rollbar incidents on record** spanning **2025-08-06** to **2026-09-01**. Status page:
[http://status.rollbar.com](http://status.rollbar.com) · platform:
`statuspage` · last polled **2026-09-09 12:30 UTC**, last observed
state **`ok`**.

Only **12** Rollbar incidents carry both a vendor-posted start and resolve time — below the 20-incident floor this dataset requires before publishing a median, so none is quoted here.
...
| 2025-08-06 | Increased occurrence processing pipeline latency | minor | 2.7 h |
