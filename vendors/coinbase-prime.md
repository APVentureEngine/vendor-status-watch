...
**56 Coinbase Prime incidents on record** spanning **2026-05-27** to **2026-09-11**. Status page:
[https://status.prime.coinbase.com](https://status.prime.coinbase.com) · platform:
`statuspage` · last polled **2026-09-12 12:30 UTC**, last observed
state **`ok`**.

Median incident length: **2.9 h** across 54 incidents where Coinbase Prime posted both a start and a resolve time.
...
| --- | --- | --- | ---: |
| 2026-09-11 | [Delayed Sends and Receives - DYDX](https://stspg.io/xxy4rjyltnj3) | none | 83 min |
