...
**84 Twilio incidents on record** spanning **2026-08-21** to **2026-09-09**. Status page:
[https://status.twilio.com](https://status.twilio.com) · platform:
`statuspage` · last polled **2026-09-09 12:30 UTC**, last observed
state **`degraded`**.

Median incident length: **7.5 h** across 74 incidents where Twilio posted both a start and a resolve time.
