# F-Secure outage history — every incident their status page has posted
...
This page republishes what F-Secure posted on its own status page. It is rebuilt
daily by an automated poller — no login, no account, MIT-licensed data.

## Recent F-Secure incidents

| Started | Incident | Impact | Length |
| --- | --- | --- | ---: |
| 2026-09-02 | [My F-Secure: Service Disruption](https://stspg.io/mwvhqhlw1v3p) | none | 24.3 h |
| 2026-07-28 | [[Resolved] Service Notification – Activation Failures (APAC/Japan Region)](https://stspg.io/ccfdkpkg86xw) | none | 24.0 h |
| 2025-09-26 | [F-Secure ID Monitoring Internal Error](https://stspg.io/dlhs5cdh8xns) | none | 45.1 days |

Newest 3 of 3. Full machine-readable history:
[`history/f-secure.json`](https://raw.githubusercontent.com/APVentureEngine/vendor-status-watch/main/history/f-secure.json).
...
**2026-09-04** — it is not a claim about F-Secure's
...
| | |
| --- | --- |
| This vendor's raw history (JSON) | [`history/f-secure.json`](https://raw.githubusercontent.com/APVentureEngine/vendor-status-watch/main/history/f-secure.json) |
...
| Alert your Slack/Discord when F-Secure breaks | [free MIT GitHub Actions template](https://github.com/APVentureEngine/vendor-status-watch-template) |
...
| Browsable board with charts | [F-Secure on the live site](https://approjects-vendor-status-watch.static.hf.space/v/f-secure.html) |
