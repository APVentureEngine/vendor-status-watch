...
| 2026-09-04 | [Elevated connectivity degradation in NRT](https://www.cloudflarestatus.com/incidents/bgbz898hh98g) | minor | — |
| 2026-09-04 | [Elevated number of R2 503 errors in Western North America region](https://www.cloudflarestatus.com/incidents/y27rg9kcyryn) | minor | 29 min |
| 2026-09-03 | [Workers Builds elevated queue times](https://www.cloudflarestatus.com/incidents/48wc4y9p1vym) | minor | 4.5 h |
| 2026-09-03 | [Increased HTTP 5xx Errors in Hong Kong.](https://www.cloudflarestatus.com/incidents/hv0y80k98t9b) | minor | 14 min |
...
**2026-09-04** — it is not a claim about Cloudflare's
...
| | |
| --- | --- |
| This vendor's raw history (JSON) | [`history/cloudflare.json`](https://raw.githubusercontent.com/APVentureEngine/vendor-status-watch/main/history/cloudflare.json) |
...
| Alert your Slack/Discord when Cloudflare breaks | [free MIT GitHub Actions template](https://github.com/APVentureEngine/vendor-status-watch-template) |
...
| Browsable board with charts | [Cloudflare on the live site](https://approjects-vendor-status-watch.static.hf.space/v/cloudflare.html) |
