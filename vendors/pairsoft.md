# PairSoft outage history — every incident their status page has posted
...
This page republishes what PairSoft posted on its own status page. It is rebuilt
daily by an automated poller — no login, no account, MIT-licensed data.

## Recent PairSoft incidents

| Started | Incident | Impact | Length |
| --- | --- | --- | ---: |
| 2025-11-17 | [Docupeak Service Interruption Alert](https://stspg.io/kgt0mlj8vt7b) | major | 5.3 h |
| 2025-10-29 | [PaperSaveCloud Service Interruption Alert](https://stspg.io/839rgk40ztbj) | none | 20.2 h |
| 2025-09-29 | [Docupeak Cloud Service - Interruption Alert](https://stspg.io/x063l04r4wr8) | minor | 51 min |

Newest 3 of 3. Full machine-readable history:
[`history/pairsoft.json`](https://raw.githubusercontent.com/APVentureEngine/vendor-status-watch/main/history/pairsoft.json).
...
**2026-09-04** — it is not a claim about PairSoft's
...
| | |
| --- | --- |
| This vendor's raw history (JSON) | [`history/pairsoft.json`](https://raw.githubusercontent.com/APVentureEngine/vendor-status-watch/main/history/pairsoft.json) |
...
| Alert your Slack/Discord when PairSoft breaks | [free MIT GitHub Actions template](https://github.com/APVentureEngine/vendor-status-watch-template) |
...
| Browsable board with charts | [PairSoft on the live site](https://approjects-vendor-status-watch.static.hf.space/v/pairsoft.html) |
