...
**52 Gandi incidents on record** spanning **2025-08-25** to **2026-09-09**. Status page:
[https://status.gandi.net](https://status.gandi.net) · platform:
`statuspage` · last polled **2026-09-09 12:30 UTC**, last observed
state **`maintenance`**.

Median incident length: **2.4 h** across 51 incidents where Gandi posted both a start and a resolve time.
...
| 2026-04-23 | [Issue on a storage unit](https://stspg.io/3sk2t8l4rhb1) | minor | 16 min |
