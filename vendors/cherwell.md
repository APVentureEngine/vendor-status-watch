...
**62 Cherwell incidents on record** spanning **2026-05-29** to **2026-09-11**. Status page:
[https://status.cherwellondemand.com](https://status.cherwellondemand.com) · platform:
`statuspage` · last polled **2026-09-12 12:30 UTC**, last observed
state **`ok`**.

Median incident length: **18.8 h** across 53 incidents where Cherwell posted both a start and a resolve time.
