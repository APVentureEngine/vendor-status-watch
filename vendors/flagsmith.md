...
**2026-09-04** — it is not a claim about Flagsmith's
...
| | |
| --- | --- |
| This vendor's raw history (JSON) | [`history/flagsmith.json`](https://raw.githubusercontent.com/APVentureEngine/vendor-status-watch/main/history/flagsmith.json) |
...
| Alert your Slack/Discord when Flagsmith breaks | [free MIT GitHub Actions template](https://github.com/APVentureEngine/vendor-status-watch-template) |
...
| Browsable board with charts | [Flagsmith on the live site](https://approjects-vendor-status-watch.static.hf.space/v/flagsmith.html) |
