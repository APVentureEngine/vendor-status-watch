...
**42 LogMeIn Pro incidents on record** spanning **2025-08-20** to **2026-09-09**. Status page:
[https://status.logmeinaccess.com](https://status.logmeinaccess.com) · platform:
`statuspage` · last polled **2026-09-11 12:29 UTC**, last observed
state **`ok`**.

Median incident length: **64 min** across 42 incidents where LogMeIn Pro posted both a start and a resolve time.

This page republishes what LogMeIn Pro posted on its own status page. It is rebuilt
daily by an automated poller — no login, no account, MIT-licensed data.

## Recent LogMeIn Pro incidents
...
**2026-09-04** — it is not a claim about LogMeIn Pro's
...
| | |
| --- | --- |
| This vendor's raw history (JSON) | [`history/logmein-pro.json`](https://raw.githubusercontent.com/APVentureEngine/vendor-status-watch/main/history/logmein-pro.json) |
...
| Alert your Slack/Discord when LogMeIn Pro breaks | [free MIT GitHub Actions template](https://github.com/APVentureEngine/vendor-status-watch-template) |
...
| Browsable board with charts | [LogMeIn Pro on the live site](https://approjects-vendor-status-watch.static.hf.space/v/logmein-pro.html) |
