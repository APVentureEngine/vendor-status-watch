...
**40 InfluxData incidents on record** spanning **2025-09-04** to **2026-09-11**. Status page:
[https://status.influxdata.com](https://status.influxdata.com) · platform:
`statuspage` · last polled **2026-09-11 12:29 UTC**, last observed
state **`ok`**.

Median incident length: **3.4 h** across 40 incidents where InfluxData posted both a start and a resolve time.
