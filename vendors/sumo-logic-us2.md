...
**43 Sumo Logic US2 incidents on record** spanning **2026-01-12** to **2026-09-04**. Status page:
[http://status.us2.sumologic.com](http://status.us2.sumologic.com) · platform:
`statuspage` · last polled **2026-09-07 12:26 UTC**, last observed
state **`ok`**.

Median incident length: **52 min** across 43 incidents where Sumo Logic US2 posted both a start and a resolve time.

This page republishes what Sumo Logic US2 posted on its own status page. It is rebuilt
daily by an automated poller — no login, no account, MIT-licensed data.

## Recent Sumo Logic US2 incidents
...
**2026-09-04** — it is not a claim about Sumo Logic US2's
...
| | |
| --- | --- |
| This vendor's raw history (JSON) | [`history/sumo-logic-us2.json`](https://raw.githubusercontent.com/APVentureEngine/vendor-status-watch/main/history/sumo-logic-us2.json) |
...
| Alert your Slack/Discord when Sumo Logic US2 breaks | [free MIT GitHub Actions template](https://github.com/APVentureEngine/vendor-status-watch-template) |
...
| Browsable board with charts | [Sumo Logic US2 on the live site](https://approjects-vendor-status-watch.static.hf.space/v/sumo-logic-us2.html) |
