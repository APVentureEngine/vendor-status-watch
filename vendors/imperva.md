...
**52 Imperva incidents on record** spanning **2026-03-27** to **2026-09-09**. Status page:
[https://status.imperva.com](https://status.imperva.com) · platform:
`statuspage` · last polled **2026-09-10 12:15 UTC**, last observed
state **`maintenance`**.

Median incident length: **3.4 h** across 52 incidents where Imperva posted both a start and a resolve time.
