...
Median incident length: **6.8 h** across 37 incidents where Brightly Software posted both a start and a resolve time.

This page republishes what Brightly Software posted on its own status page. It is rebuilt
daily by an automated poller — no login, no account, MIT-licensed data.

## Recent Brightly Software incidents

| Started | Incident | Impact | Length |
| --- | --- | --- | ---: |
| 2026-09-10 | [Asset Essentials - Login Issue](https://stspg.io/k2rlzrsv7gpp) | minor | 25.8 h |
...
| 2026-06-26 | [Support service disruption](https://stspg.io/8gjwc3tjwvmn) | none | 3.6 h |
| 2026-06-19 | [Asset Essentials - Dashboard redirect issue](https://stspg.io/hxyjh5m3l874) | minor | 17.2 days |
| 2026-06-17 | [Event Manager - Unable to Edit Events](https://stspg.io/09h7z3cq0h3r) | minor | 3.3 h |
| 2026-06-16 | [Errors within TheWorxHub](https://stspg.io/z67p44t8vpzq) | minor | 9.1 days |
...
**2026-09-04** — it is not a claim about Brightly Software's
...
| | |
| --- | --- |
| This vendor's raw history (JSON) | [`history/brightly-software.json`](https://raw.githubusercontent.com/APVentureEngine/vendor-status-watch/main/history/brightly-software.json) |
...
| Alert your Slack/Discord when Brightly Software breaks | [free MIT GitHub Actions template](https://github.com/APVentureEngine/vendor-status-watch-template) |
...
| Browsable board with charts | [Brightly Software on the live site](https://approjects-vendor-status-watch.static.hf.space/v/brightly-software.html) |
