# Lotame outage history — every incident their status page has posted
...
This page republishes what Lotame posted on its own status page. It is rebuilt
daily by an automated poller — no login, no account, MIT-licensed data.

## Recent Lotame incidents

| Started | Incident | Impact | Length |
| --- | --- | --- | ---: |
| 2026-08-25 | [Platform UI/API Degradation](https://stspg.io/1nwwv347n0sp) | none | 0 min |
| 2026-06-29 | [Dropbox Outage](https://stspg.io/rtylgjcp4nkm) | none | 0 min |
| 2026-04-22 | [Edge Services Degredation](https://stspg.io/nk41xn47zx2t) | major | 2.0 h |
| 2025-10-20 | [Regional Edge Services Degradation](https://stspg.io/8sf28317grwy) | major | 9.4 h |

Newest 4 of 4. Full machine-readable history:
[`history/lotame.json`](https://raw.githubusercontent.com/APVentureEngine/vendor-status-watch/main/history/lotame.json).
...
**2026-09-04** — it is not a claim about Lotame's
...
| | |
| --- | --- |
| This vendor's raw history (JSON) | [`history/lotame.json`](https://raw.githubusercontent.com/APVentureEngine/vendor-status-watch/main/history/lotame.json) |
...
| Alert your Slack/Discord when Lotame breaks | [free MIT GitHub Actions template](https://github.com/APVentureEngine/vendor-status-watch-template) |
...
| Browsable board with charts | [Lotame on the live site](https://approjects-vendor-status-watch.static.hf.space/v/lotame.html) |
