# Airbrake outage history — every incident their status page has posted
...
This page republishes what Airbrake posted on its own status page. It is rebuilt
daily by an automated poller — no login, no account, MIT-licensed data.

## Recent Airbrake incidents

| Started | Incident | Impact | Length |
| --- | --- | --- | ---: |
| 2026-07-13 | [Metric graphs not loading](https://stspg.io/mykp3p8l7l7y) | major | 12.2 h |
| 2026-06-01 | [Email notifications](https://stspg.io/np98ycz2sd2s) | major | 90 min |
| 2026-05-06 | [Error dashboard loading issues](https://stspg.io/lb9wb9fx874g) | none | 0 min |

Newest 3 of 3. Full machine-readable history:
[`history/airbrake.json`](https://raw.githubusercontent.com/APVentureEngine/vendor-status-watch/main/history/airbrake.json).
...
**2026-09-04** — it is not a claim about Airbrake's
...
| | |
| --- | --- |
| This vendor's raw history (JSON) | [`history/airbrake.json`](https://raw.githubusercontent.com/APVentureEngine/vendor-status-watch/main/history/airbrake.json) |
...
| Alert your Slack/Discord when Airbrake breaks | [free MIT GitHub Actions template](https://github.com/APVentureEngine/vendor-status-watch-template) |
...
| Browsable board with charts | [Airbrake on the live site](https://approjects-vendor-status-watch.static.hf.space/v/airbrake.html) |
