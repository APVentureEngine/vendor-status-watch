...
## Recent MxToolbox incidents

| Started | Incident | Impact | Length |
| --- | --- | --- | ---: |
| 2026-02-23 | [Red MxError / Parse Syntax in Monitoring and Notification UI](https://stspg.io/pklkpqwr5sx7) | minor | 19.4 h |
| 2026-02-13 | [MailFlow Monitoring Impacted by SpamHaus Blocklisting](https://stspg.io/vgw734j2h9d4) | minor | 4.8 h |
| 2025-12-10 | [MxToolbox Monitoring & Delivery Center Outage](https://stspg.io/2qgc9s06fyz9) | major | 66 min |
...
**2026-09-04** — it is not a claim about MxToolbox's
...
| | |
| --- | --- |
| This vendor's raw history (JSON) | [`history/mxtoolbox.json`](https://raw.githubusercontent.com/APVentureEngine/vendor-status-watch/main/history/mxtoolbox.json) |
...
| Alert your Slack/Discord when MxToolbox breaks | [free MIT GitHub Actions template](https://github.com/APVentureEngine/vendor-status-watch-template) |
...
| Browsable board with charts | [MxToolbox on the live site](https://approjects-vendor-status-watch.static.hf.space/v/mxtoolbox.html) |
