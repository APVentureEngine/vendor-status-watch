...
**57 Kraken incidents on record** spanning **2026-05-24** to **2026-09-08**. Status page:
[https://status.kraken.com](https://status.kraken.com) · platform:
`statuspage` · last polled **2026-09-08 12:29 UTC**, last observed
state **`degraded`**.

Median incident length: **6.0 h** across 48 incidents where Kraken posted both a start and a resolve time.
...
| --- | --- | --- | ---: |
| 2026-09-08 | [Delayed Historical Balance Data](https://stspg.io/2yqmgclztspf) | minor | — |
...
Of 57 recorded incidents, **48** have a usable length. Excluded:
