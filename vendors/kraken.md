...
Median incident length: **6.0 h** across 52 incidents where Kraken posted both a start and a resolve time.
...
Of 60 recorded incidents, **52** have a usable length. Excluded:
