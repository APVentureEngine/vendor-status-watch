...
| Incidents on record | **15,222** across 651 vendors |
| Opened in the last 30 days | **2,411** |
| Median incident length | **2.3 h**, 90th percentile **28.1 h**, from 14,451 incidents with a vendor-posted start *and* resolve time — per-vendor table on [how long outages last](https://approjects-vendor-status-watch.static.hf.space/outage-duration.html) |
