...
| Incidents on record | **15,163** across 651 vendors |
| Opened in the last 30 days | **2,412** |
| Median incident length | **2.3 h**, 90th percentile **27.9 h**, from 14,407 incidents with a vendor-posted start *and* resolve time — per-vendor table on [how long outages last](https://approjects-vendor-status-watch.static.hf.space/outage-duration.html) |
